...
\subfigure[Global Component][$l_u=.58$,$l_v=0$]{
...
% The
% camera is mounted vertically above a table that holds the surface. The scene is
...
% lighting direction, using component separation technique described in \cite{C9},
% 25 images are captured and then we separate the image into its global and direct components. The resultant
% dataset used for modeling contains 60 images per surface, with 2 from each lighting direction.
