...
\centering
\subfigure[]{
\includegraphics[scale=.16]{image_eps/orig_some/0.eps}
}
\subfigure[]{
\includegraphics[scale=.16]{image_eps/orig_some/9.eps}
}
\subfigure[]{
\includegraphics[scale=.16]{image_eps/orig_some/10.eps}
}
\subfigure[]{
\includegraphics[scale=.16]{image_eps/orig_some/26.eps}
}
\label{fig:3dtexture} 
...
\centering
\subfigure{
\includegraphics[height=3.9in,width=5.3in]{chap4/res_7/text_chall.eps}
}
\caption
