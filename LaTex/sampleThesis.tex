...
\newpage
\thispagestyle{empty}
\renewcommand{\thesisdedication}{{\large Copyright \copyright~~Siddharth Kherada, December 2013\\}{\large All Rights Reserved\\}}
\thesisdedicationpage
...
\newpage
\thispagestyle{empty}
\renewcommand{\thesisdedication}{\large To My Parents and My Advisor}
\thesisdedicationpage
...
\chapter{Component Based Texture Modeling}
\label{ch:chap3}
\input{chapter3.tex}

%--------------------------------------------------------

\chapter{Component Based Text Segmentation}
\label{ch:chap4}
\input{chapter4.tex}
